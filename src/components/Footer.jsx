            ...
            <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
                ...
                <BrainCircuit className='w-8 h-8'/> Echo.ai
                        ...
                        <p className="mt-6 text-sm">
                            Echo.ai empowers creators with cutting-edge AI tools to write, design, and innovate faster than ever. From generating content to enhancing workflows, we help you turn ideas into reality—seamlessly and creatively.
                        </p>
                    </div>
                ...
                <p className="pt-4 text-center text-xs md:text-sm pb-5">
                    Copyright {new Date().getFullYear()} © <a href="https://prebuiltui.com">EchoAI</a>. All Right Reserved.
                </p>
            </footer>
        )
    }
